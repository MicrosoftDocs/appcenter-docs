...
> [!TIP]
> You may need to unblock `build.appcenter.ms` and `build-new.appcenter.ms` to allow the build agent to connect to your repo. Possible [Azure IP addresses](/azure/devops/pipelines/agents/hosted?tabs=yaml#networking).
