...
By default, App Center displays an app's crashes and errors per day in a side by side view. By clicking into the Crashes or Errors tab, this view will get filtered respectively. Click on a group to find more information including a list of specific reports, devices and OSs affected.
