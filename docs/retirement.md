...
| <b>CodePush</b>           | We have prepared a special version of <b>CodePush</b> that can be integrated into your app and run independently from App Center. You can access the source code and the documentation, which explains how to deploy and run it, in the following GitHub repository: https://github.com/microsoft/code-push-server. |
