...
2. Click your username on the bottom-left hand corner and select **Account Settings**.

	![The account details menu to select Settings](~/api-docs/images/mc_menu_dialog.PNG)

3. Select **API Tokens** from the menu list.
4. Click **New API token**  at the top.
5. Enter a descriptive name for your token in the text field.
...
11. In the upper-right corner of the page, click on the **Authorize** button.
...
13. Click the "X" in the top right-hand corner to exit the the pop up.
14. You are now able to use any App Center API and see the response.
...
4. In the left-hand corner, click the **Try it out** button.
