...
In order to track handled errors in App Center, we recommend that you use the specific functionality for it. Check out more information on this [here](~/errors/index.md).
