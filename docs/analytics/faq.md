...
The country is determined by the carrier country and requires that the device has a SIM. If you are using a tablet or a device with no SIM card, the country won't be reported. If you are using a simulator, the country information will most probably not be accurate.
