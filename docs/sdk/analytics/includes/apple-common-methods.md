...
> [!NOTE]
> On Mac Catalyst app, amount of sessions may be lower than that on iOS apps. The reason is that the lifecycle events used to track sessions on Mac Catalyst behave differently from those on iOS.
