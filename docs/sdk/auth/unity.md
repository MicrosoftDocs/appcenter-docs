...
async void signIn() {
    try {
        ...
        string accessToken = userInformation.accessToken;
        string idToken = userInformation.idToken;
...
//Code Example for decoding tokens
...
public class TokenInfo
{
    ...
    /// </summary>
    public static TokenInfo DecodeToken(string inputText)
    {
        ...
        return JsonUtility.FromJson<TokenInfo>(decodedText);
    }
}

TokenInfo info = TokenInfo.DecodeToken(accessToken);
```
