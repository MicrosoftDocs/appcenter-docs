...
1. Open your application target's **General** settings tab. Drag and drop the **AppCenterAuth** from the **Carthage/Build/iOS/Static** folder to the **Linked Frameworks and Libraries** section of XCode.
