...
In the event we have network issues or we have an outrage on the endpoint and you restart the app, `SendingErrorReport` is replayed after process restart.
