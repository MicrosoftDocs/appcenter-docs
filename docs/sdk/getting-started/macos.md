...
1. Open your application target's **General** settings tab. Drag and drop each framework you want to use from the **Carthage/Build/macOS/Static** folder to the **Linked Frameworks and Libraries** section of XCode.
