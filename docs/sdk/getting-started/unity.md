...
In order to learn how coroutines/callbacks instead of `async/await` with `.NET 3.5` backend, refer to the [Asyncronous APIs in the Unity SDK](https://docs.microsoft.com/en-us/appcenter/sdk/unity-async) section of the documentation.
