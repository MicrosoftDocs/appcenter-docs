...
> [!NOTE]
> Due to [termination of jCenter support](https://jfrog.com/blog/into-the-sunset-bintray-jcenter-gocenter-and-chartcenter/) we're moving our assemblies to the Maven repository. Please follow [this guide](../troubleshooting/react-native.md) about migration from jCenter to Maven.
