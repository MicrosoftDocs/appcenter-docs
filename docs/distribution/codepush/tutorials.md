...
> [!NOTE]
> This tutorial does not cover how to enable CodePush on an app. If you need help setting up CodePush, visit the [Cordova](./cordova.md#getting-started) or [React Native](./rn-overview.md#getting-started) "Getting Started" sections.
...
Visit the  [Cordova](./cordova.md#api-reference) or [React Native](./rn-overview.md#api-reference) API Reference pages for a full description of all the available UpdateDialogOptions options.
...
Visit the  [Cordova](./cordova.md#syncstatus) or [React Native](./rn-overview.md#syncstatus) SyncStatus enum for a full description of all the available enum values.
