...
> [!NOTE]
> Due to country specific policies and laws, we cannot guarantee that App Center works in all countries. For some users in China region, SDK data may not make it to our servers based in the United States. 
