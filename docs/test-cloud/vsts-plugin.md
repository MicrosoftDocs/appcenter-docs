...
* Configure the pipeline to use Node 10.x.x. [Read how to on the Azure DevOps documentation](/azure/devops/pipelines/ecosystems/javascript), the documentation is about Javascript but the principle applies here as well.
