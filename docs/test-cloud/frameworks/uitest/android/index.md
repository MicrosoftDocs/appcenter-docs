appcenter test run uitest --app "Apple-Store/Cloudflare" --devices 5e5c54a9 --app-path pathToFile.apk --test-series "main-dot-c" --locale "en_US" --build-dir pathToUITestBuildDir
