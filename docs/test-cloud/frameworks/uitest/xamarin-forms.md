...
- [Introduction to UITest for Xamarin.Android](~/test-cloud/frameworks/uitest/upload-droid.md)
- [Introduction to UITest for Xamarin.iOS](~/test-cloud/frameworks/uitest/upload-ios.md)
...
For information about how to submit tests to App Center Test, see [Submitting UITests for Xamarin.Android](~/test-cloud/frameworks/uitest/upload-droid.md) or [Submitting UITests for Xamarin.iOS](~/test-cloud/frameworks/uitest/upload-ios.md). For more information about UITest, see [App Center Test documentation](~/test-cloud/index.md).
