...
2. Unzip the file and you will see a folder called `MobileCenter-SDK` that contains different frameworks for each Mobile Center service. The framework called `MobileCenter` is required in the project as it contains code that is shared between the different modules.
...
4. Open Finder and copy the unzipped `MobileCenter-SDK` folder into your project's folder at the location where you want it to reside.
