...
* **APP NAME** &ndash; The name of the app that was created in Mobile Center.
...
2. Install the [Mobile Center CLI](~/cli/index.md). Instructions for [installing the Mobile Center CLI](https://github.com/Microsoft/mobile-center-cli#installation) maybe be found in the [README.md on Github](https://github.com/Microsoft/mobile-center-cli).
