...
## My iOS app fails to run a test with the following error `ld: directory not found for option - iPhoneSimulator10.3.sdk/Developer/Library/Frameworks`, how can I fix this?

This error usually appears with the following lines.<br />
