...
If your build log contains `RequireProvisioningProfile: True` even though you selected **Sign builds: Off** in the Mobile Center branch configuration, open **Project Options > Build > iOS Bundle Signing** in your IDE and check that your project configuration does not contain any signing information other then **Automatic**. Especially you **Debug|iPhoneSimulator** configuration should not contain any signing information if you don't want to sign it in the Mobile Center.
