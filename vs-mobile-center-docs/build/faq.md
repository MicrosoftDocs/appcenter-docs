...
From May 17th, we changed our build tools to use [xcodebuild](~/build/ios/xcodebuild.md) intead of xcrun and it is stricter. All builds kicked off after this date will use [xcodebuild](~/build/ios/xcodebuild.md).
