...
* if the build was reconfigured to use xcodebuild instead of xcrun, unsigned builds will not produce an .ipa file. The artifact of an unsigned build is the .xcarchive file which can be used to generate an .ipa file with Xcode Archives organizer.
